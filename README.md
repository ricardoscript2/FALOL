...
local Window = OrionLib:MakeWindow({Name = "ricardo hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "ricardo hub"})
...
W:AddLabel("[+] ricardo hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "ricardo hub(Noitification)",
